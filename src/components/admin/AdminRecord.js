      ...
      <div className="mb-6">
        {filters.map((filter, index) => (
          <div key={index} className="flex items-center mb-4">
            <select
              className="border p-2 mr-4 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded shadow"
              value={filter.key}
            ...
            <input
              className="border p-2 flex-grow bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded shadow"
              type="text"
        ...
        <div className="flex items-center">
          <div className="mr-4">
            ...
            <DatePicker
              ...
              className="border p-2 w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded shadow"
