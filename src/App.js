...
const BrowseByCorrespondent = lazy(() => import("./pages/BrowseByCorrespondent"));
const BrowseByTopic = lazy(() => import("./pages/BrowseByTopic"));
const AdvancedSearchPage = lazy(() => import("./pages/AdvancedSearchPage"));
const HeatmapPage = lazy(() => import("./pages/HeatmapPage")); // New lazy-loaded HeatmapPage
const StatisticsPage = lazy(() => import("./pages/StatisticsPage")); // New lazy-loaded StatisticsPage
      ...
      <div className="flex-grow">
        <Suspense fallback={<div>Loading...</div>}>
          <Routes>
            ...
            <Route path="/heatmap" element={<HeatmapPage />} /> {/* New Route */}
